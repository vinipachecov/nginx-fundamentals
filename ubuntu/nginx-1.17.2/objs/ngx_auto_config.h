#define NGX_CONFIGURE " --sbin-path=/usr/bin/nginx --conf-path=/etc/nginx/nginx.conf --error-log-path=/home/nginx/error.log --http-log-path=/home/nginx/access.log --with-pcre --pid-path=/var/run/nginx.pid --with-http_ssl_module --with-http_image_filter_module=dynamic --modules-path=/etc/nginx/modules --with-http_v2_module"

#ifndef NGX_COMPILER
#define NGX_COMPILER  "gcc 7.3.0 (Debian 7.3.0-19) "
#endif
...
#define NGX_ERROR_LOG_PATH  "/home/nginx/error.log"
#endif


#ifndef NGX_HTTP_LOG_PATH
#define NGX_HTTP_LOG_PATH  "/home/nginx/access.log"
#endif
