#define NGX_CONFIGURE " --sbin-path=/usr/bin/nginx --conf-path=/etc/nginx/nginx.conf --error-log-path=/home/nginx/error.log --http-log-path=/home/nginx/log/nginx/access.log --with-pcre --pid-path=/var/run/nginx.pid"
...
#define NGX_HTTP_LOG_PATH  "/home/nginx/log/nginx/access.log"
#endif
